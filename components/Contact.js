...
export default function Contact() {
  return (
    <section>
      ...
      <div className="relative z-10 rounded-md shadow-md bg-[#02044A] p-4 md:p-10 lg:p-20 max-w-4xl mx-auto mb-20 -mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            <header className="">
              <h1 className="text-gray-50 font-semibold text-2xl">
                Get in touch, let's Connects.
              </h1>
            ...
            <div className="icons-container inline-flex flex-col my-20 text-center">
              ...
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A]  p-4 ">
                ...
                <p className="text-gray-50 font-light text-sm text-center">
                  {userData.phone}
                </p>
              </div>
  */}
